...
const Hero = () => {
  return (
    <div id='top' className='relative pb-20 pt-36'>
      <div className='pointer-events-none absolute top-0 left-1/2 h-full w-screen max-w-none -translate-x-1/2 overflow-hidden'>
